#CHAID1
## all are Factors/ Categories, this is the time we use CHAID
### fit tree to subsample

library(CHAID)
set.seed(290875)
data(USvote)  ## To load the data set. i.e to create it in the environment
attach(USvote)
?USvote      # also tells that in which library we have this data
head(USvote)
str(USvote)
names(USvote)
summary(USvote)
...
# Splits using KaiSquare Statistics
