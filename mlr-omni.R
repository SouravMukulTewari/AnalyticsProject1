...
#MLR
?lm  # function(arguments)
(mlrmodel1 = lm(formula = sales ~ price + promotion, data=omni))  # sales dependent on price and promotion both
# or
...
fitted(mlrmodel1)
names(omni)
(ndata1 = data.frame(price=c(60,70), promotion=c(300,400))) # target inputs for which I need to find the Sales value
